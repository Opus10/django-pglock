...
Set up your development environment with:
    ...
    git clone git@github.com:Opus10/django-pglock.git
    cd django-pglock
    make docker-setup
...
Anything that is merged into the master branch will be automatically deployed to PyPI. Documentation will be published to a ReadTheDocs at `https://django-pglock.readthedocs.io/`.
